...
public class UserControllerUnitTest {
    ...
    public void whenCalledshowSignUpForm_thenCorrect() {
        User user = new User("Nali", "nali@domain.com", 70809, "Vizbegovo");

        assertThat(userController.showForm(user)).isEqualTo("add-user");
    }
    ...
    public void whenCalleddeleteUser_thenIllegalArgumentException() {
        assertThat(userController.delete(1l, mockedModel)).isEqualTo("index");
    }
}